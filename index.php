      ...
      <div class="newsletter-popup"> <img class="offer" src="images/newsbg.jpg" alt="offer">
        <div class="newsletter-popup-static newsletter-popup-top">
          <div class="popup-text">
            <div class="popup-title">Free <span>Now</span></div>
            <div class="popup-desc">
              <div>Sign up for our newslatters free for a limited time</div>
            </div>
          </div>
                    ...
                    <div class="item">
                      <div class="product-thumb">
                        ...
                        <div class="caption product-detail text-center">
                          <h6 data-name="product_name" class="product-name"><a href="#" title="Casual Shirt With Ruffle Hem">Available for pre-order NOW !</a></h6>
                  ...
                  <div class="box-holder">
                    <div class="thumb post-img"><a href="#"> <img src="images/blog/blog_img_01.jpg" alt="themini"> </a>
                      ...
                      <div class="post-info">
                        ...
                        <p>High-end mechanical watches are as relevant today as they were before.</p>
                        <div class="view-blog">
                ...
                <div class="item">
                  <div class="box-holder">
                    <div class="thumb post-img"><a href="#"> <img src="images/blog/blog_img_02.jpg" alt="themini"> </a>
                      ...
                      <div class="post-info">
                        <h6 class="mb_10 text-uppercase"> <a href="single_blog.html">Fashions fade, style is eternal</a> </h6>
                        <p>Traditional luxury watch manufacturers are challenged by new digital-first analog watch brands and smartwatch companies.</p>
                        <div class="view-blog">
                          <div class="write-comment pull-left"> <a href="single_blog.html"> 0 Comments</a> </div>
                          <div class="read-more pull-right"> <a href="single_blog.html"> <i class="fa fa-link"></i> read more</a> </div>
                        </div>
      ...
      <div class="footer-bottom mt_60 ptb_20">
        <div class="container">
          <div class="row">
            ...
            <div class="col-sm-4">
              <div class="copyright-part text-center">@ 2017 All Rights Reserved Watchers bačers</div>
            </div>
            <div class="col-sm-4">
